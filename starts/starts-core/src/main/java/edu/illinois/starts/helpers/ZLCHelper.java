...
//    }
    ...
    /*
     * Note: must be called after getChangedData.
     */
    public static Set<String> getChangedMethods() {
...
//            System.out.println("imprecision due to static field");
    ...
    public static Set<String> getExistingClasses(String artifactsDir, boolean useThirdParty) {
        ...
        try {
            ...
            for (String line : zlcLines) {
                if (line.startsWith("file") || (useThirdParty && line.startsWith("jar"))) {
