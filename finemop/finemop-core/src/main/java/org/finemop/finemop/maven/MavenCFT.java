package org.finemop.finemop.maven;

import java.lang.instrument.ClassFileTransformer;
import java.lang.instrument.IllegalClassFormatException;
import java.security.ProtectionDomain;

import org.finemop.finemop.maven.asm.ClassReader;
import org.finemop.finemop.maven.asm.ClassVisitor;
import org.finemop.finemop.maven.asm.ClassWriter;
import org.finemop.finemop.maven.asm.MethodVisitor;
import org.finemop.finemop.maven.asm.Opcodes;
...
public final class MavenCFT implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        String surefireMojoInterceptor = "org/finemop/finemop/maven/SurefireMojoInterceptor";
